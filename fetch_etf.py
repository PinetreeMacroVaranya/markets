...
ETF_UNIVERSE = [
    ...
    "ARKK","ARKQ","ARKW","ARKG","ARKF","ARKX","ARKB","ARKZ","ARKD",
    ...
    "AMLP","COAL","ENFR","MLPA","MLPX","TPYP","KDEF","MLPB","AMZA","AMJB",
    "PFF","PFFD","FPE","SIL","SPFF","PFXF","HYD","HYMB","MUNI","CMF",
    "BKLN","SRLN","FLBL","FLRN","FLTR","FLOT","USFR","TFLO","ICSH","NEAR",
    "SHV","BIL","SGOV","CLTL","TBLL","TBIL","GBIL","VBIL","SEF","OPER",
    ...
    "DXJ","HEDJ","HEFA","DBEF","DBEZ","HEWJ","HEWG","UFO","HEEM","HEZU",
